...
#	print("ID: %s" % id)
	if type_id[0] == 'h':
#		print("SETTING ID FOR %s, %s" % [id, type_id])
		object.id = id
	add_child(object)
	if Global.in_house != "" and not VillageMap.house_maps[Global.in_house]['objects'].get(id):
#		print("ADDING TO HOUSE MAP")
#		print(VillageMap.house_maps)
...
#			print(VillageMap.village_map)
			...
			print(VillageMap.village_map)
		elif type_id[0] != 'h' and not VillageMap.village_map['objects'].get(id):
#			print("ADDING TO VILLAGE MAP 2")
#			print(VillageMap.village_map)
